...
from dspilot_core.llm.processors.base_processor import ToolResultProcessor
...
class SearchToolResultProcessor(ToolResultProcessor):
    ...
    def can_process(self, tool_name: str) -> bool:
        ...
        search_tools = {"search_web", "search_with_time_filter", "duckduckgo_search", "web_search"}
