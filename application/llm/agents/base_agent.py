    ...
    async def _analyze_tool_results_with_llm(
        ...
        try:
            ...
            analysis_prompt = (
                ...
                f"수집된 정보:\n{formatted_results}\n\n"
                "위 정보를 바탕으로 사용자의 요청에 적절한 수준의 답변을 제공해주세요.\n\n"
                "**답변 작성 지침:**\n"
                "- 사용자의 질문이 간단한 사실 확인이면 간결하고 직접적으로 답변\n"
                "- 복잡한 분석이나 설명이 필요하면 상세하고 구조화된 답변 제공\n"
                "- 질문의 성격과 범위에 맞는 적절한 깊이로 정보 전달\n"
                "- 범용 MCP 도구 시스템의 결과를 효과적으로 활용\n\n"
                "사용자가 원하는 수준의 정보를 정확하고 유용하게 제공해주세요."
            )
